  ...
  public:
    ...
    std::vector<int> depthSearch(int count)
    {
      ...
      while(!s.empty())
      {
         ...
         {
           std::cout << "Startings: " << hold->data << std::endl; 
           ...
           std::cout << "Data 1: " << hold->adjacencyList[i]->node1->data<< std::endl;
           int data2 = hold->adjacencyList[i]->node2->data;
           std::cout << "Data 2: " << hold->adjacencyList[i]->node2->data<< std::endl;
           if(hold->data == data)
           {
             std::cout << "Triggering 1"<< std::endl;   
             if (hold->adjacencyList[i]->node2->viewed != true)
             {
                 std::cout << "I have taken1: " << hold->adjacencyList[i]->node2->data  << std::endl;
             ...
             {
               std::cout << "I have taken2: " << hold->adjacencyList[i]->node1->data  << std::endl; 
           ...
           else if(hold->data == data2)
           {
             ...
             std::cout << "Triggering 2"<< std::endl;
             if (hold->adjacencyList[i]->node1->viewed != true)
             {
                 std::cout << "I have taken3: " << hold->adjacencyList[i]->node1->data  << std::endl;
                 hold = hold->adjacencyList[i]->node1;
                 hold->viewed = true;
                 std::cout << "Hold is:  " << hold->data  << std::endl;
                 std::cout << "Hold adjacency 1 is: " << hold->adjacencyList[0]->node1->data << hold->adjacencyList[0]->node1->viewed  << std::endl;
                 std::cout << "Hold adjacency 2 is: " << hold->adjacencyList[0]->node2->data << hold->adjacencyList[0]->node2->viewed  << std::endl;
                 s.push(hold);
                 visited.push_back(hold->data);
                 i=-1;
             }
             ...
             {
               std::cout << "I have taken4: " << hold->adjacencyList[i]->node2->data << std::endl; 
               hold = hold->adjacencyList[i]->node2;
               s.push(hold);
               hold->viewed = true;
               visited.push_back(hold->data);
