...
class Vertex
{
  /*
    ...
    list and a Boolean flag for whether it has been viewed or not.
  */    
  friend Graph;
  ...
  public:
  	...
  	{
  	    /*
          This is the destructor for the Vertex class. In this it performs 
          the 'clean up' operations for the class, this means resetting the 
          adjacency list as we don't want pointers to unknown memory locations. 
...
{
   /*
    This class creates a graph object which will create vertices and edges
    to connect them together. From there it offers two ways to create a 
    connection, manually and automatically. Alongside these features the
  ...
  private:
  	...
  	bool inadjacencyList(int count, int value, int value2)
  	{
  	   /*
  	     ...
  	     pointers for the passed in value. If it is in the array it will return
  	...
  	void priv_autoConnect()
  	{
        ...
        edge array to keep track of it. It will then add this edge to the
        adjacency list for both the vertices it connects to. 
        This will connect all vertices together automatically, so the first half the
        list will connect with the top half. Then it will go up one vertex in
        the graph vertex array and connect it to its corresponding number in 
        the other half of the list. An example being 0 through 10, 0 and 10 will
  	  ...
  	  */
  	  ...
  	  for(int i = vertexList.size()-1; i >= (vertexList.size()/2); i--)
  	  {
  	    /*
  	       ...
  	       point all vertices should be connected together forming a connected graph.
  	    */ 
  	 ...
  	 if(!hold.empty())
     {
        ...
        {
            /*
                First stage of the sorting to make sure the whole list is 
                sorted
            */
  	...
  	{
  	    /*
  	        This function will map the graph by starting at a given point and 
  	    ...
  	    */
  	    ...
  	    else
  	    {
      	   ...
      	   while(!pq.empty())
           {
            ...
            {
                /*
                  Refill the list based upon the sorted list so that the vertex 
            ...
            hold = {};
      	    ...
      	    while(!pq.empty())
      	    {
      	        /*
                    ...
                    in the que and perform a breadth search on it to
  	...
  	{
  	   /*
  	    This will create a new edge which connects two vertices together. This 
        being the function where the user can manually connect two vertices together
  	  */
    ...
    {
      /*
        Go through the vertex list and reset the vertices to un-viewed so other
    ...
    std::vector<int> priv_depthSearch(int start)
    {
      /*
        ...
        that point it will go down any other connections in the current vertex
        till all connections are visited. It will then go back a vertex and repeat
        ...
        for the current vertex it will be popped of the stack and the top of the stack 
      ...
      else
      {
          while(!s.empty())
          {
             /*
                ...
                far as it can, e.g. until there is no further connections. 
                Adding to the stack when it visits a vertex and popping when all 
                the vertexs connections are exhausted.   
             */ 
             ...
             for(int i = 0; i < size; i++)
             {
               /*
                 ...
                 list. It will then push the connected vertex to the stack 
                 and  mark it as viewed, change current vertex to the connected
                 vertex and resets the iteration counter to the beginning of the 
                 adjacency list. 
               */ 
    ...
    std::vector<int> priv_breadthSearch(int start)
    {
      /*
         ...
         to it. As a vertex is visited it will be added to the queue so that 
         once all the connected vertices of a given vertex are visited it will move 
         onto the first vertex in the que. It will repeat this activity until 
  ...
  public:
  	...
  	Vertex* getVertex(int value)
  	{
  	    ...
  	    */
  	    ...
  	    {
  	        /*
  	            Iterates through the vertex list setting a temporary vertex pointer so
  	...
  	void printDijkstra(std::vector<Vertex*> hold)
  	{
        ...
        {
          /*
            Goes through the graphs Vertex list printing out the distance between
            them and the start vertex along with the previoius vertex so you can 
  	...
  	std::vector<Vertex*> dijkstra(int start)
    {
  	...
  	void printConnections(int count)
  	{
        ...
        appropriate value based on which vertex in the edge points to it and to the
        connecting vertex.
  	  */
  	  Vertex* hold = vertexList[count];
  	  for(int i = 0; i < hold->adjacencyList.size(); i++)
