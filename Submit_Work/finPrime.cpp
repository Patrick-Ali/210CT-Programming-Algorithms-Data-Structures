...
{
    /*
        Takes in two numbers, the first being the number we are testing
        the second is an ever-decreasing number until it hits 1.
        It checks if num1 can be wholly divided by num2 as if it can 
    ...
    */
    ...
    else if (num1%num2 == 0)//can num1 be wholly divided by num2 
    {
        return false;
    }
    else
