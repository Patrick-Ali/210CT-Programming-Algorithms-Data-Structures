...
class Node
{
    /*This class handles the initiation and destruction of a node*/
...
class BST
{
    ...
    */
            ...
            else
            {
                ...
                while(!s.empty())
                {
                    ...
                    */
                    ...
                    {
                        /*
                            This will continually push the current node onto a stack
    ...
    public:
        ...
        {
            /*
                When called this will print out all parents and any children they
                have, if there are no children on that side it will say so.
            */
